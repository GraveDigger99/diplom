(() => {
    ...
    function initSliders() {
        if (document.querySelector(".reason__slider")) if (window.innerWidth <= 577) new core(".reason__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".cost__slider")) if (window.innerWidth <= 991.98) new core(".cost__slider", {
    ...
    da.init();
    const cardsValues = document.querySelectorAll(".card-cost__value");
    if (cardsValues) document.addEventListener("click", (function(e) {
        let targetElement = e.target;
        if (targetElement.closest(".second")) {
            console.log("1");
            cardsValues[0].innerHTML = "1130 ₽";
            cardsValues[1].innerHTML = "1380 ₽";
            cardsValues[2].innerHTML = "1750 ₽";
        }
        if (targetElement.closest(".first")) {
            console.log("0");
            cardsValues[0].innerHTML = "840 ₽";
            cardsValues[1].innerHTML = "1020 ₽";
            cardsValues[2].innerHTML = "1290 ₽";
        }
    }));
    window["FLS"] = false;
    spollers();
